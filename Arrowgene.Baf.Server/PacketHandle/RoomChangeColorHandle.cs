...
{
    public class RoomChangeColorHandle : PacketHandler
    {
        private static readonly BafLogger Logger = LogProvider.Logger<BafLogger>(typeof(RoomChangeColorHandle));

        public override PacketId Id => PacketId.RoomChangeColorReq;
